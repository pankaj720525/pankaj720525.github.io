...
function Navbar() {
  ...
  const classes = useMemo(() => {
    const defaultClasses =
      "bg-dark flex items-center pr-3 z-12 fixed w-full z-10 border-b border-slate-50 transition-all";
  ...
  return (
    <header className={classes}>
      ...
      >
        ...
        {!showNavbar && (
          <motion.div
            className=" relative font-bold font-title header-name px-2 flex flex-row justify-center items-center"
            initial={{
              translateX: "10vw",
              opacity: 0.8,
            }}
          ...
          >
            Green Earth Energy Solution Rajula (Hiren Mer)
