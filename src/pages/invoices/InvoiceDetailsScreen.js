      ...
      {invoiceForm && (
        ...
        >
          ...
          <div
            className={
              isExporting
                ? "py-5 px-8 bg-cover bg-center bg-slate-50 rounded-xl flex flex-row justify-between items-center box-bg-img"
                : "py-9 px-8 bg-cover bg-center bg-slate-50 rounded-xl flex flex-col sm:flex-row justify-between items-center box-bg-img"
            }
            // style={{
            //   backgroundImage: `url(${box_background_img})`,
            // }}
          >
            <div
              className={
            ...
            >
              ...
              >
                <p className="font-bold mb-2">
                  {invoiceForm?.companyDetail?.companyName || "Green Earth Energy Solution Rajula"}
                </p>
                ...
                <p className="text-sm font-medium">
                  {invoiceForm?.companyDetail?.companyMobile || "9737110707"}
                </p>
                <p className="text-sm font-medium">
